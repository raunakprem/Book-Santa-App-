...
export default class WelcomeScreens extends Components {
    constructor(){
        super();
        this.state={
            emailId:'',
...
firebase.auth().signInWtEmailAndPasworn(emailId,password)
.then(()=>{
    return Alert.alert("Sucsessfully loged in")
        ...
        return(
            <View styles= {styles.container}>
             ...
             />
                        ...
                        onPress ={()=>{this.userLogin(this.state.emailId,this.state.pasword) }}
                        >
